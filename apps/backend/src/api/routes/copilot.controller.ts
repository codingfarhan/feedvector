import { Logger, Controller, Get, Post, Req, Res, Query, Param, HttpException } from "@nestjs/common"
...
export class CopilotController {
  constructor(private _subscriptionService: SubscriptionService, private _mastraService: MastraService) {}
  @Post("/chat")
  ...
  async agent(@Req() req: Request, @Res() res: Response, @GetOrgFromRequest() organization: Organization) {
    ...
    runtimeContext.set("integrations", req?.body?.variables?.properties?.integrations || [])
