  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 21 20" fill="none">
        <path d="M10.5001 4.16699V15.8337M4.66675 10.0003H16.3334" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
...
export function MobileCreateActionsFab({ channelsCount }: { channelsCount: number }) {
  const t = useT()
  ...
  }, [addChannel, channelsCount, createPost, modals, t])
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 21 20" fill="none">
        <path d="M10.5001 4.16699V15.8337M4.66675 10.0003H16.3334" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </button>
  )
}
