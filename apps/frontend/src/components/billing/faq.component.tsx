  ...
  return [
    ...(user?.allowTrial
      ? [
          ...
          //     'Am I going to be charged by FeedVector?'
          //   ),
          //   description: t(
          //     'faq_to_confirm_credit_card_information_postiz_will_hold',
          //     'To confirm credit card information FeedVector will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
          //   ),
          // },
        ]
      : []),
    {
      title: t("faq_can_i_trust_postiz_gitroom", `Can I trust ${isGeneral ? "FeedVector" : "Gitroom"}?`),
      description: t(
        "faq_postiz_gitroom_is_proudly_open_source",
        `${isGeneral ? "FeedVector" : "Gitroom"} is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? "FeedVector" : "Gitroom"
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/codingfarhan/feedvector" target="_blank" style="text-decoration: underline;">click here</a>.`,
      ),
    },
    {
      ...
      description: t(
        ...
        `${isGeneral ? "FeedVector" : "Gitroom"} allows you to schedule your posts between different channels.
...
export const FAQSection: FC<{
  ...
  return (
    <div className="bg-sixth p-[24px] border border-tableBorder rounded-[8px] flex flex-col" onClick={changeShow}>
      ...
      <div className={clsx("transition-all duration-500 overflow-hidden", !show ? "max-h-[0]" : "max-h-[500px]")}>
        <div
          onClick={(e) => {
            e.stopPropagation()
          }}
