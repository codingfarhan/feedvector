  ...
  const firstMenu = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none">
          <path
            d="M7.5 11H16.5M7.5 14H13.5M8.6 18.8L5.5 21V17.2C4.25 16.26 3.5 14.82 3.5 13.25V9.25C3.5 5.94 6.19 3.5 9.5 3.5H14.5C17.81 3.5 20.5 5.94 20.5 9.25V13.25C20.5 16.56 17.81 19 14.5 19H10.2C9.56 19 9.18 19 8.6 18.8Z"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
