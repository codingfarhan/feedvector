...
export const useMenuItem = () => {
  ...
  const firstMenu = [
    ...
    {
      name: t("engage", "Engage"),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none">
          <path
            d="M7 10.5H17M7 14H13M8.8 20H15.2C16.8802 20 17.7202 20 18.362 19.673C18.9265 19.3854 19.3854 18.9265 19.673 18.362C20 17.7202 20 16.8802 20 15.2V8.8C20 7.11984 20 6.27976 19.673 5.63803C19.3854 5.07354 18.9265 4.6146 18.362 4.32698C17.7202 4 16.8802 4 15.2 4H8.8C7.11984 4 6.27976 4 5.63803 4.32698C5.07354 4.6146 4.6146 5.07354 4.32698 5.63803C4 6.27976 4 7.11984 4 8.8V15.2C4 16.8802 4 17.7202 4.32698 18.362C4.6146 18.9265 5.07354 19.3854 5.63803 19.673C6.27976 20 7.11984 20 8.8 20Z"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none">
          <path
            d="M7.5 3.5H16.5C17.9001 3.5 18.6002 3.5 19.135 3.77248C19.6054 4.01217 19.9878 4.39462 20.2275 4.86502C20.5 5.3998 20.5 6.09987 20.5 7.5V16.5C20.5 17.9001 20.5 18.6002 20.2275 19.135C19.9878 19.6054 19.6054 19.9878 19.135 20.2275C18.6002 20.5 17.9001 20.5 16.5 20.5H7.5C6.09987 20.5 5.3998 20.5 4.86502 20.2275C4.39462 19.9878 4.01217 19.6054 3.77248 19.135C3.5 18.6002 3.5 17.9001 3.5 16.5V7.5C3.5 6.09987 3.5 5.3998 3.77248 4.86502C4.01217 4.39462 4.39462 4.01217 4.86502 3.77248C5.3998 3.5 6.09987 3.5 7.5 3.5Z"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path d="M8 9H16M8 12.5H14.25M8 16H12" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
      path: "/templates",
    },
    ...
    <>
      <div className="flex flex-1 flex-col minCustom:gap-[16px] blurMe">
        {
          ...
          user?.orgId &&
            ...
            firstMenu
              ...
              .map((item, index) => <MenuItem path={item.path} label={item.name} icon={item.icon} key={item.name} />)
        }
      </div>
      <div className="flex flex-col minCustom:gap-[16px] blurMe">
        {secondMenu
          ...
          .map((item, index) => (
            <MenuItem path={item.path} label={item.name} icon={item.icon} key={item.name} />
          ))}
      </div>
    </>
  )
